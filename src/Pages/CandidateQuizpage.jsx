...
//         toast.error("Unable to load candidate or quizzes.",err);
//       } finally {
//         setLoading(false);
//       }
//     };
    ...
    <div className="min-h-screen py-12">
      <div className="candidate-quiz-container max-w-3xl mx-auto p-10 bg-white rounded-3xl shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-50 p-5 rounded-2xl shadow-inner mb-8 border border-blue-100">
          ...
          <p>
            <strong className="text-blue-600">Description:</strong>{candidate?.description}
          </p>
          <p>
            <strong className="text-blue-600">Difficulty:</strong> {candidate?.difficulty}
          </p>
        </div>
